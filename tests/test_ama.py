...
class AMATests(unittest.TestCase):
    ...
    def test_wav(self):
        ...
        with aaf2.open(new_file, 'r') as f:
            ...
            self.assert_mastermob_valid_edit_spec(master_mob=master_mob, expected_sound_slots=1, expected_picture_slots=0)
    ...
    def test_avc_mov(self):
        ...
        with aaf2.open(new_file, 'w') as f:
            ...
            for (pix_fmt, profile) in avc_profiles:
                ...
                mov = common.generate_mov('ama_avc_%s.mov' % profile, overwrite=False, vcodec=vcodec, audio_channels=audio_channel_count)
    ...
    def test_prores(self):
        ...
        with aaf2.open(new_file, 'w') as f:
            ...
            for profile, name in prores_profiles:
                ...
                mov = common.generate_mov('ama_prores_%s.mov' % (name,), overwrite=False, vcodec=vcodec, audio_channels=2)
                meta = common.probe(mov)
                mobs = f.content.create_ama_link(mov, meta)
